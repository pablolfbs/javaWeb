...
import com.motta.Util;
import com.motta.dao.pool.ConnectionPool;
...
public class TestConnectionPool {
	...
	public static void init(){
		...
		try {
			pool = new ConnectionPool.Builder()
				...
				.setMaxCapacity(10)
				.setStep(2)
				.setConnectionString("jdbc:mysql://localhost:3306/motta")
	...
	public void testConnectionPool(){
		...
		assertTrue(pool.getConnectionString().equals("jdbc:mysql://localhost:3306/motta"));
		...
		Runnable r = new Runnable(){
			...
			public void run() {
				...
				try {
					...
					long period = new Double(d).longValue();
					Thread.sleep(period);
