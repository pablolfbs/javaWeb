...
//			Address[] toUser = InternetAddress.parse("lista de emails");// Array de Destinatï¿½rios
			Address[] toUser = InternetAddress.parse(destinatario);// Array de Destinatï¿½rios

			message.setRecipients(Message.RecipientType.TO, toUser);// Destinatï¿½rios
