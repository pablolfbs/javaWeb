 ...
 * 
 *         Esta classe representa o pool de conexões. Ela é responsável por
 *         instanciar inicialmente algumas conexões (definido o número inicial
 *         pelo usuário) e acrescentar novas conexões de acordo com a demanda.
 * 
 * 
 */
