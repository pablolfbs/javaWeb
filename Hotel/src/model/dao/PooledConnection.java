...
/**
 * @author Pedro Abs pedro_abs@yahoo.com.br Esta classe é um Decorator para a
 *         conexão real que implementa a interface Connection.
 * 
 *         Observe o método close. Ao invés de fechar a conexão a devolvemos
 *         para o pool.
 */
public class PooledConnection implements Connection, Comparable<PooledConnection> {
	...
	/**
	 * Ao invés de fechar a conexão simplesmente a devolvemos para o pool.
	 */
	@Override
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof PooledConnection) {
			...
			if (this.getCreationTime() == other.creationTime && this.id == other.id)
				return true;
		}
		return false;
	...
	public int hashCode() {
		...
		return Double.valueOf(this.id).hashCode() + Long.valueOf(this.creationTime).hashCode();
	}
