		...
		<div class="col s12 z-depth-6 card-panel">
			<nav>
				<div class="nav-wrapper">
					<div class="col s8">
						<h3 class="brand-logo col s8">Digite seu E-mail</h3>
					</div>
				</div>
			</nav>
			<form class="senha-form" action="entrada" method="POST">
				<div class="row"></div>
				<div class="row">
				...
				<div class="row">
					<div class="input-field col s12">
						<button class="btn waves-effect waves-light col s12 waves-orange hoverable" type="submit" id="botao" value="resetarSenha" name="acao">Enviar</button>
					</div>
				</div>
				<div>
