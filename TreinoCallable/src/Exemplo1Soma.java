...
public class Exemplo1Soma {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		while(!futureT1.isDone() && !futureT2.isDone() && !futureT1.isDone()) {
			System.out.println("As tarefas ainda não foram processadas!");
//			Thread.sleep(1);
		}
		System.out.println("Tarefa completa!");
		long valor = futureT1.get() + futureT2.get() + futureT3.get();
		System.out.println("A soma dos valores gerados é: " + valor);
